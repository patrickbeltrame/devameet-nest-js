export const UserMessagesHelper = {
    ...
    REGISTER_PASSWORD_NOT_VALID: 'Senha informada não é válida, ela precisa ter de 4 a 12 caracteres e comter pelo menos um caracter maiusculo, um minusculo, um numero e um caracter especial',
